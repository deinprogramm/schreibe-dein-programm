...
\end{itemize}
%
Mit Symbolen und Quote können wir sowas wie einen Taschenrechner
programmieren, der den Wert von Ausdrücken wir \lstinline{(+ 23 65)}
ausrechnen kann.  Wir legen dafür folgende Datendefinition zugrunde:
%
\begin{lstlisting}
