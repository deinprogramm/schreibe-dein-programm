...
\textit{Bindungen\index{Bindung}}, den den Tupeln
...
\end{lstlisting}
%
In dieser Schablone werden nun die Regeln direkt abgebildet.  Hier zur
...
\end{lstlisting}
%
Bei der Regel für Variablen wird der Wert der Variablen aus der
Umgebung geholt und auf den Stack gelegt:
\begin{displaymath}
  (\underline{s}, e, v\underline{c}, \underline{d})
  \hookrightarrow
  (e(v)\underline{s}, e, \underline{c}, \underline{d})
