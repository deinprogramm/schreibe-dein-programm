...
%
\begin{itemize}
\item \lstinline{Signature}\index{signature@\texttt{signature}} müssen wir immer schreiben, wenn wir eine
...
(define heat-water
  (lambda (temp heat)
    (cond
x      ; Anfangstemperatur ist unter 0|\si{\degree}|C, es wird also Eis erwärmt.
      ((< temp 0)
       (cond
         (|\ldots| |\ldots|)
         (|\ldots| |\ldots|)
...
\begin{aufgabeinline}
  ...
  wir auch definieren, in was \lstinline{(and)} und \lstinline{(or)} (also
