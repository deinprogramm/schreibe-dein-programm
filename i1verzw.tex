...
Signatur-Definition stehen.  Wir müssen deshalb nicht noch separat
...
\end{displaymath}
%
Etwas scher zu erkennen in dieser Schreibweise: Die Bedingung $t < 0$
...
%
\begin{aufgabeinline}
  In der Mathematik gibt den "<Absolutbetrag">\index{Absolutbetrag} einer
...
\begin{aufgabe}
  ...
  \item Schreibe eine Funktion \lstinline{valid-value?}, die überprüft ob die erste von
    ...
    "<zwischen"> ist gemaint, dass die erste Zahl auch gleich der
