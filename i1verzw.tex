...
Celsius (°C).\footnote{Wir vereinfachen schon sehr stark, aber 
...
\item Die dritte Version berücksichtigt zusätzlich, dass gefrorenem
  Wasser von 0°C eine Wärme von 80°C hinzugefügt werden muss, damit es
...
unterhalb von 0°C die Temperatur und die Wärme einander.  Bei Wärme
zwischen 0°C und 80°C ist die Temperatur konstant 0°C. Ab 80°C Wärme
führt jedes Grad Erhöhung auch zu einer Erhöhung der Temperatur, bis
100°C Temperatur beziehungsweise 180°C Wärme erreicht sind.  Ab da
bleibt die Temperatur bei 100°C, auch wenn die Wärme steigt.
...
nennen sie \texttt{temperature->heat}. Diese Funktion ist einfacher:
Temperaturen bis 0°C entsprechen der Wärme, Temperaturen darüber
brauchen 80°C mehr Wärme.  Es gibt also nur zwei Fälle und damit zwei
Zweige:
%
\begin{lstlisting}
...
als Übeltäter.  Deren Bedingungen schließen Temperaturen über 100°C
