...
\end{alltt}
%
Fertig~-- könnte man meinen.  Wenn Sie das Programm in laufen lassen,
...
%
\begin{itemize}
\item Punktestand vorher (natürliche Zahl)
\item freiwillige Maßnahme (siehe Abschnitt~\ref{sec:fallunterscheidungen})
\end{itemize}
%
Die unbekannte Größe ist der Punktestand nachher.
