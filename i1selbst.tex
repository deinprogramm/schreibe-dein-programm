...
\paragraph{Kombinatorrepräsentationen finden} Wie schon am Anfang
dieses Abschnitts erwähnt, die Autoren des Papers über Finanzverträge
habne Monate gebraucht, um die beschriebene elegante Repräsentation zu
...
\item Sie haben nach Kombinatoren für Finanzverträge gesucht und
  welche gefunden, entsprechend Mantra~\ref{mantra:kombinatoren}.
\end{itemize}
%
...
\begin{aufgabe}\label{aufgabe:aufzaehlung-vs-nullstellig}
  ...
  \lstinline{"one-euro"} verwenden.  Versuche dies umzusetzen!
\end{aufgabe}
