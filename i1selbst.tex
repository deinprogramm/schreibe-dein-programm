...
%
\begin{lstlisting}
(define later1 (make-later date1 euro100)) ; Ich bekomme Neujahr 2020 100€.
(define later2 (make-later date2 euro200)) ; Ich bekomme am 27.7.2019 200€.
\end{lstlisting}
%
...
\lstinline{contract-payment} ist \lstinline{(later-daet contract)},
