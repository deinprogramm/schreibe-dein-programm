...
\item Schreiben Sie "<Induktionsschluss (zu zeigen):">.
  ...
  $n\in\mathbb{N}$"> weg.)
\item Beweisen Sie den Induktionsschluss unter Verwendung der
  Induktionsvoraussetzung.  

  Wenn die Behauptung eine Gleichung der Form $A = B$ ist, dann lässt
...
\item Wenn die Klausel einen oder mehrere Selbstbezüge enthält, so
  ...
  Schreiben Sie darunter das Wort "<Induktionsschluss"> und beweisen
...
\begin{aufgabe}
  Beweisen Sie, dass folgende Gleichung für alle $n\in\enn$ gilt:
  \begin{displaymath}
...
\begin{aufgabe}
  ...
  Folgen umwandeln lässt.  Setzen Sie dann die Klauseln der
