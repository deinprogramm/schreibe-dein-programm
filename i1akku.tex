...
das bisherige Zwischenergebnis an, falls es gerade ist:
%
\begin{lstlisting}
(define evens
  (lambda (list0)
...
in welcher Reihenfolge.  Wir sollten noch sie so erweitern:
%
\begin{lstlisting}
; evens enthält die geraden Zahlen zwischen list0 und list
...
Wir müssen die Funktion noch korrigieren.  Glücklicherweise geht das
