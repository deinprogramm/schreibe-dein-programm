...
\begin{lstlisting}
(: list-fold-left
   ((list-of %a) %acc (%a %acc -> %acc) (%acc -> %b) -> %b))
\end{lstlisting}
%
\begin{figure}[tb]
  \centering
...
\begin{aufgabe}
  Schreibe eine iterative Variante von \texttt{list-min-nonempty} in
  Abschnitt~\ref{func:list-min-nonempty} auf
  Seite~\pageref{func:list-min-nonempty}.
\end{aufgabe}
