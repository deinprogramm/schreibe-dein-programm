...
\begin{aufgabeinline}
  Ändere die Funktion dahingehend, dass eine Person nicht ihr eigener
  Vorfahr ist.  Wird die Funktion einfacher?
\end{aufgabeinline}

\section{Binärbäume}
\label{sec:trees}

FIXME: An \lstinline{confluence} andocken und darüber abstrahieren.

FIXME: Doch Stammbaum mit \lstinline{parent-1} und \lstinline{parent-2}
