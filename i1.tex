...
\documentclass[disablefront,liststyle=aligned]{suftesi}
...
\theoremheaderfont{\small\sffamily\bfseries}
...
\newtheorem{konstruktionsanleitung}{Konstruktionsanleitung}%[chapter]

\def\subbib#1#2{\section*{#2}\list
 {[\arabic{enumi}]}{\settowidth\labelwidth{[#1]}\leftmargin\labelwidth
 \advance\leftmargin\labelsep
 \usecounter{enumi}}
 \def\newblock{\hskip .11em plus .33em minus -.07em} \sloppy
 \sfcode`\.=1000\relax}
\let\endsubbib=\endlist
...
\maketitle
\bookcolophon{Copyright \textcopyright{} 2007-2014 by Herbert Klaeren and Michael
  Sperber
  ...
  Dieses Buch wurde mit \LaTeX{} gesetzt,
  unter Verwendung der \textsf{suftesi}-Klasse
  von Ivan Valbusa.}
\end{titlepage}
