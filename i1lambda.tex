...
%
\begin{eqnarray*}
  % Zumindest im verlinkten PDF auf der Website wird das Lambda auf
  % der rechten Seite in den ersten beiden Beispielen nicht gerendert...?!
...
\begin{definition}[Linksaußen-Reduktion]
  ...
  %
  \begin{enumerate}
    % Das Lambda im PDF wird wieder nicht angezeigt
