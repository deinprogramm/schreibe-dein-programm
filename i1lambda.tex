...
FIXME Namen und deren Bedeutungen
...
FIXME: Aufgabe klassifizieren, vorher Beispiele durchgehen

% 
In diesen konkreten Beispielen haben wir als Variablen $\lrm x$, $\lrm y$ und
$\lrm f$ verwendet.

FIXME: Die Buchstaben haben keine besondere Bedeutung.
...
FIXME: noch mehr zu Namen haben keine Bedeutung
...
% Italics erläutern? Oder "kursiv"? Italics ist nicht geläufig
