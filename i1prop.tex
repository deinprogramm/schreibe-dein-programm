...
\item \lstinline{Proper-sized-search-tree?} liefert \emph{immer}
  ...
  ausgeschlossen.
\item Die Fehler in der Funktion \lstinline{proper-sized-search-tree?} entsprechen genau
  so den Fehlern in \lstinline{balanced-search-tree-insert}.
  Um dem
  vorzubeugen, entwickeln wir die Funktion \lstinline{proper-sized-search-tree?}
  ...
  bei der Funktion \lstinline{balanced-search-tree-insert}, und damit
  wahrscheinlicher, dass das Ergebnis korrekt ist.
\end{itemize}
%
