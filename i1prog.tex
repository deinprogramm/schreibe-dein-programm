...
eine kurze Beschreibung auf Deutsch voran, die
...
Wenn die Eingaben der Funktion den Signaturen \(s\sb{1} \ldots
...
übrigbleibt~-- andernfalls müssen wir mehr Tests schreiben kann.  Wir
...
%
Für jeden diese Schritte gibt es jeweils eine Konstruktionsanleitung,
...
\texttt{billig-strom} betrifft, keinen Sinn, da jeder Tests dafür
sorgt, dass die Addition und die Multiplikation in
\texttt{billig-strom} ausgwertet werden.  In
...
\end{restatable}
% 
Das genaue Lesen fällt uns aber erstaunlich schwer.  Für dieses Buch
...
\end{restatable}
%
Die Konstruktionsanleitungen helfen uns, Fortschritte zu machen, auch
...
\end{restatable}
%
Bisher haben wir nur kleine Programme mit ein, zwei oder drei
...
\end{restatable}
%
Wir werden oft mathematische Einsichten in Form von Gleichungen
...
\end{restatable}
%
Manchmal macht es Spaß, ein kompliziertes Programm zusammenzubasteln
