...
"`die \emph{Summ} von Hundertdreiundzwanzig und zweiundvierzig"'.
...
Die Funktion \texttt{+} (was eine Funktion ist, behandeln wir später),
dann die \texttt{123}, dann \texttt{42}.  Ähnlich verhält es sich mit
...
Funktion \texttt{string-append}\index{string-append@\texttt{string-append}}, die zwei Zeichenketten
aneinanderhängt:
%
\begin{alltt}
