...
in Deinem Programm schreiben kannst, was Du weißt:
%
\begin{mantra}
  \label{mantra:ka}
...
\end{mantra}
%
Das nächste Prinzip ist ein Mantra, weil DrRacket (oder andere
Programmierumgebungen) oft nützliche Rückmeldungen geben, diese aber
auf den ersten Blick mühsam zu lesen sind.  Es lohnt sich trotzdem
fast immer:
%
\begin{mantra}
  \label{mantra:lies}
  Wenn DrRacket Dir Rückmeldung zu Deinem Programm gibt, lies
  gründlich, was dort steht.
\end{mantra}
%
