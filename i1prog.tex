...
\section{Die Konstruktionsanleitung}
...
die Grundgebühr das Produkt aus dem Verbrauchspreis addieren.  Für
...
wir \emph{über kWh abstrahieren} \index{abstrahieren} (so sagt man
...
Als nächstes ergänzen wir eine \textit{Signatur\index{Signatur}}, die
...
\begin{aufgabe}
 ...
 \begin{itemize}
  ...
  \end{itemize}
  % Schreiben Sie für jede Funktion Kurzbeschreibung, Signatur, Testfälle, Gerüst und Rumpf.
