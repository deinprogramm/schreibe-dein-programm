...
hierher bewegen und \lstinline{f} in \lstinline{w} umbenennen. Das \drscheme{}-System
bietet dazu nach einem Klick auf "<Syntaxprüfung"> die Möglichkeit, mit einem
Rechtsklick auf den Parameter \lstinline{f} ein Menü aufzuklappen, das unter
anderem die Auswahl "<\lstinline{f} umbenennen"> anbietet. \drscheme{} sorgt dann
dafür, dass alle zugehörigen Vorkommen von \lstinline{f} in gleicher Weise
