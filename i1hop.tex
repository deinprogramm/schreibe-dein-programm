...
\lstinline{list-fold} und sieht folgendermaßen aus (die Signatur muss noch
...
\end{lstlisting}
%
Die Signatur für \lstinline{list-fold} ist nicht auf den ersten Blick
...
Die Definition von \lstinline{concatenate} aus
Abschnitt~\ref{sec:more-lists} passt ebenfalls auf das abstrahierte
Muster von \lstinline{list-fold}:
%
\begin{lstlisting}
...
\lstinline{list-fold}, da \lstinline{make-pair} nicht die Signatur
%
\begin{lstlisting}
%a %a -> %a
\end{lstlisting}
...
%a %b -> %b
\end{lstlisting}
besitzt.  \lstinline{List-fold} hat also folgende Signatur:
%
\begin{lstlisting}
