...
Ab diesem Kapitel wird die Sprachebene \texttt{Die Macht der
  Abstraktion} (ohne "`Anfänger"') benötigt.
...
\begin{aufgabe}
  ...
  \item  Schreiben Sie eine Prozedur
    ...
    $c_1$ und eine Liste von Grundkreaturen akzeptiert.  Die Prozedur
