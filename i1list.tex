...
\begin{aufgabe}
Schreiben Sie folgende Prozeduren auf Listen zu schreiben:
  
  \begin{enumerate} 
    
  \item Eine Prozedur \texttt{count-zeroes}, die die Anzahl von Nullen
    in einer Liste von Zahlen berechnet.
    
  \item Eine Prozedur \texttt{contains>10?}, die feststellt, ob eine
...
\begin{aufgabe}
  ...
  \item Eine Maschine soll nun die Kartoffeln aus dem
    ...
    Schreiben Sie die Prozedur \texttt{harvester}, die diesen Vorgang
    simuliert. Als Eingabe bekommt diese Prozedur eine Liste von
    ...
    Maschine im Leerlauf betrieben wird.  Verwenden Sie die Prozeduren
    aus den vorherigen Aufgabenteilen.
...
\begin{aufgabe}
  ...
  Schreiben Sie eine Prozedur, die eine Liste von Personalakten
...
\begin{aufgabe}
  ...
  \end{enumerate}
  Benutzen Sie bei jeder Prozedur und jedem Record, den Sie schreiben,
...
\begin{aufgabe}
  ...
  \item Schreiben Sie eine Prozedur
    ...
    Wenn die Prozedur auf eine leere Liste angewendet
    wird, soll die Prozedur eine \texttt{violation} produzieren.
  \item Schreiben Sie eine Prozedur
  ...
  \item  Schreiben Sie eine Prozedur \texttt{sort}, die
...
\begin{aufgabe}
  ...
  \item  Schreiben Sie eine Prozedur
    ...
    $c_1$ und eine Liste von Grundreaturen akzeptiert.  Die Prozedur
    ...
    die Liste der Grundkreaturen leer ist, soll die Prozedur \verb|#f|
    zurückgeben.

  \item  Schreiben Sie eine Prozedur
    \texttt{breed-optimal-partner}, die eine Grundkreatur $c_1$ und
    eine Liste von Grundkreaturen akzeptiert.  Die Prozedur soll $c_1$
  ...
  \item  Schreiben Sie eine Prozedur
    ...
    akzeptiert.  Die Prozedur soll die beiden Grundkreaturen aus der
