...
Viele Computerhändler erlauben Ihre Kunden, bestimmte Komponenten
...
\end{itemize}
%
Natürlich besteht ein Computer auch noch aus anderen Teilen, aber
diese Teile sind (zumindest in diesem Beispiel) immer gleich, sie
können vom Kunden nicht ausgewählt werden.  In einer Bestellung muß
...
\textit{Komponenten\index{Komponente}} (in diesem Fall Prozessor, RAM
und Festplatte) bestehen, heißt \textit{Record}.  Alle
...
\end{verbatim}
%
Riesengürteltiere werden um die 60kg schwer.   Hier sind einige
Exemplare:
%
\begin{verbatim}
