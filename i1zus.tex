...
Definition einer neuen Art zusammengesetzter Daten ist, dass Du eine klare
...
für zusammengesetzte Daten kannst Du direkt in Code umwandeln.  In den
...
\end{verbatim}
%
Es hilft dem Verständnis zumindest am Anfang, dass wir die Signaturen
...
zu zusammengesetzten Daten in Form von Konstruktionsanleitungen zusammen.
...
Wenn Du eine Funktion schreibst, die zusammengesetzte Daten als
Eingabe akzeptiert (das ergibt sich aus der Signatur), gehe nach
...
\end{enumerate}
%
Mit etwas Übung kannst Du nicht benötigte Selektor-Anwendung auch
...
%
\begin{quote}
  Wenn die Funktion zusammengesetzte Daten als Ausgabe hat, schreibe
