...
\texttt{define-record} beginnt.  Hier ist die
...
sie \texttt{define-record}.  Als erstes nach
dem \texttt{define-record} steht der Name der Signatur für
...
\begin{feature}{\texttt{define-record} (einfach)}{scheme:define-record-simple}
...
\texttt{define-record} Definitionen anlegt:
%
\begin{itemize}
\item $t$ ist der Name der Record-Signatur.
\item $c$ ist der Name des Konstruktors, den
  \texttt{define-record} anlegt.  Der Konstruktor hat 
  folgende Signatur:
%  
\begin{alltt}
...
zu verwechseln mit der Signatur, die ebenfalls \texttt{dillo} heißt. Das
