...
\begin{aufgabe}
  ...
  Schreiben sie ein Programm zur Verwaltung von Raumreservierungen!
...
\begin{aufgabe}
  ...
  Schreiben Sie weitere Prozeduren für die Computer aus der Vorlesung:
  %
  \begin{itemize}
  ...
  \item Schreiben Sie eine Prozedur, die den Speicher eines Computers
    ausbaut.  Sie akzeptiert einen Computer und eine Zahl und liefert
...
\begin{aufgabe}
  ...
  Grundkreaturen. So wird bei der Kreuzung von Ronugor und Tschipotol
